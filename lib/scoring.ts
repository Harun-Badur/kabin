...
/**
 * Trend çarpanları. Personal V1 ağırlıklarını ezmez; yalnızca applyFeedMode
 * trend seçildiğinde uygular. Uzaktan recs_config.trend_scoring_boost okunur.
 */
...
/** Personal: config aynen. Trend: freshness/novelty/deal öne, explicit constraint’ler aynı kalır. */
